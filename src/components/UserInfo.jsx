      ...
      <div className="w-[90%] flex flex-col gap-4 md:grid md:grid-cols-[1.4fr_1fr] md:items-start">
        <div className="flex flex-col justify-center gap-2">
          ...
          <div className="flex justify-between mt-4 gap-4 md:justify-normal md:w-full ">
            <Link to="/projects">
              <button className="h-10 w-36 bg-black text-white text-xs md:hover:bg-white md:hover:text-black md:hover:border md:hover:border-black transition-colors duration-300">
                View My Work
              </button>
            </Link>
            <Link to="/contact">
